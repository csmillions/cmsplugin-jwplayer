...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JWVideo.jwplayer_script'
        db.alter_column(u'cmsplugin_jwplayer_jwvideo', 'jwplayer_script', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'JWVideo.jwplayer_script'
        db.alter_column(u'cmsplugin_jwplayer_jwvideo', 'jwplayer_script', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'cmsplugin_jwplayer.jwvideo': {
            ...
            'jwplayer_script': ('django.db.models.fields.CharField', [], {'default': "'/static/js/jwplayer/jwplayer.js'", 'max_length': '200', 'null': 'True', 'blank': 'True'}),
