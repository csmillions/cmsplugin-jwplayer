...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JWVideo.use_aspect_ratio'
        db.add_column(u'cmsplugin_jwplayer_jwvideo', 'use_aspect_ratio',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'JWVideo.use_reserve_height'
        db.add_column(u'cmsplugin_jwplayer_jwvideo', 'use_reserve_height',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JWVideo.use_aspect_ratio'
        db.delete_column(u'cmsplugin_jwplayer_jwvideo', 'use_aspect_ratio')

        # Deleting field 'JWVideo.use_reserve_height'
        db.delete_column(u'cmsplugin_jwplayer_jwvideo', 'use_reserve_height')
